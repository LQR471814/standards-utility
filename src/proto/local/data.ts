    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated Page pages */ 4:
          message.pages.push(
            Page.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
        default:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated float lines */ 3:
          ...
          else message.lines.push(reader.float());
          break;
        default:
          let u = options.readUnknownField;
          if (u === "throw")
...
class Measures$Type extends MessageType<Measures> {
  ...
  internalBinaryRead(
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* Box bounds */ 1:
          message.bounds = Box.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.bounds
...
class Page$Type extends MessageType<Page> {
  ...
  create(value?: PartialMessage<Page>): Page {
    ...
    if (value !== undefined) reflectionMergePartial<Page>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
      ...
      switch (fieldNo) {
        ...
        case /* repeated Section sections */ 2:
          message.sections.push(
            Section.internalBinaryRead(reader, reader.uint32(), options)
          );
          break;
...
class Section$Type extends MessageType<Section> {
  ...
  internalBinaryWrite(
    ...
    /* int32 from = 1; */
    if (message.from !== 0) writer.tag(1, WireType.Varint).int32(message.from);
    /* int32 to = 2; */
    if (message.to !== 0) writer.tag(2, WireType.Varint).int32(message.to);
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated Tool tools */ 1:
          ...
          else message.tools.push(reader.int32());
          break;
        case /* TaskState state */ 2:
          message.state = TaskState.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.state
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated bool completed */ 1:
          ...
          else message.completed.push(reader.bool());
          break;
        case /* int32 number */ 2:
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* repeated bool right */ 1:
          ...
          else message.right.push(reader.bool());
          break;
        case /* repeated bool left */ 2:
          if (wireType === WireType.LengthDelimited)
            for (let e = reader.int32() + reader.pos; reader.pos < e; )
              message.left.push(reader.bool());
          else message.left.push(reader.bool());
          break;
        case /* int32 number */ 3:
          message.number = reader.int32();
          break;
...
class TaskState$Type extends MessageType<TaskState> {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        case /* SingleState handsTogether */ 1:
          message.hands = {
            oneofKind: "handsTogether",
            handsTogether: SingleState.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.hands as any).handsTogether
            ),
          };
          break;
        case /* HandsSeparate handsSeparate */ 2:
          message.hands = {
            oneofKind: "handsSeparate",
            handsSeparate: HandsSeparate.internalBinaryRead(
              reader,
              reader.uint32(),
              options,
              (message.hands as any).handsSeparate
            ),
          };
          break;
        case /* SingleState eyesClosed */ 3:
          message.eyesClosed = SingleState.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.eyesClosed
        ...
        case /* SingleState memorized */ 4:
          message.memorized = SingleState.internalBinaryRead(
            reader,
            reader.uint32(),
            options,
            message.memorized
  ...
  internalBinaryWrite(
    ...
    if (message.hands.oneofKind === "handsTogether")
      SingleState.internalBinaryWrite(
        message.hands.handsTogether,
        writer.tag(1, WireType.LengthDelimited).fork(),
        options
      ).join();
    /* HandsSeparate handsSeparate = 2; */
    if (message.hands.oneofKind === "handsSeparate")
      HandsSeparate.internalBinaryWrite(
        message.hands.handsSeparate,
        writer.tag(2, WireType.LengthDelimited).fork(),
        options
      ).join();

...
class Box$Type extends MessageType<Box> {
  ...
  create(value?: PartialMessage<Box>): Box {
    ...
    if (value !== undefined) reflectionMergePartial<Box>(this, message, value);
    return message;
  }
  internalBinaryRead(
    reader: IBinaryReader,
  ...
  internalBinaryWrite(
    ...
    /* double x1 = 1; */
    if (message.x1 !== 0) writer.tag(1, WireType.Bit64).double(message.x1);
    /* double y1 = 2; */
    if (message.y1 !== 0) writer.tag(2, WireType.Bit64).double(message.y1);
    /* double x2 = 3; */
    if (message.x2 !== 0) writer.tag(3, WireType.Bit64).double(message.x2);
    /* double y2 = 4; */
    if (message.y2 !== 0) writer.tag(4, WireType.Bit64).double(message.y2);
    let u = options.writeUnknownFields;
    if (u !== false)
      (u == true ? UnknownFieldHandler.onWrite : u)(
        this.typeName,
